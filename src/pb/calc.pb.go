...
func (*CalcRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_calc_949be08380c260bd, []int{0}
}
...
func (*CalcReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_calc_949be08380c260bd, []int{1}
}
...
func init() { proto.RegisterFile("calc.proto", fileDescriptor_calc_949be08380c260bd) }

var fileDescriptor_calc_949be08380c260bd = []byte{
